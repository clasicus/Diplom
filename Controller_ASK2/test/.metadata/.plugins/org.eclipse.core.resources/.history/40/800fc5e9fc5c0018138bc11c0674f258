...
HAL/src/%.o: ../HAL/src/%.c
	...
	gcc -I"D:\cygwin64\lib\gcc\i686-pc-cygwin\6.4.0\include" -I"D:\cygwin64\usr\include" -I"D:\cygwin64\usr\include\w32api" -O2 -g -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
