...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_irq_mapper.sv"                            -work irq_mapper                                                                       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                       -work rsp_xbar_mux_001                                                                 
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_rsp_xbar_mux_001.sv"                      -work rsp_xbar_mux_001                                                                 
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                       -work rsp_xbar_mux                                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_rsp_xbar_mux.sv"                          -work rsp_xbar_mux                                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_rsp_xbar_demux_002.sv"                    -work rsp_xbar_demux_002                                                               
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_rsp_xbar_demux.sv"                        -work rsp_xbar_demux                                                                   
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                       -work cmd_xbar_mux                                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_cmd_xbar_mux.sv"                          -work cmd_xbar_mux                                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_cmd_xbar_demux_001.sv"                    -work cmd_xbar_demux_001                                                               
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_cmd_xbar_demux.sv"                        -work cmd_xbar_demux                                                                   
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_id_router_002.sv"                         -work id_router_002                                                                    
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_id_router.sv"                             -work id_router                                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_addr_router_001.sv"                       -work addr_router_001                                                                  
  vlog -sv "$QSYS_SIMDIR/submodules/cpu_ASK2_addr_router.sv"                           -work addr_router                                                                      
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L irq_mapper -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L limiter -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L pio_I_max -L pio_SDO_ADC -L pio_keyboard_SW6_SW1 -L pio_A1_A0 -L pio_res_nSOE -L pio_res_nWr -L pio_lcd_control -L pio_lcd_data -L pio_angle -L sysid_qsys_0 -L jtag_uart_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L irq_mapper -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L limiter -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L pio_I_max -L pio_SDO_ADC -L pio_keyboard_SW6_SW1 -L pio_A1_A0 -L pio_res_nSOE -L pio_res_nWr -L pio_lcd_control -L pio_lcd_data -L pio_angle -L sysid_qsys_0 -L jtag_uart_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver $TOP_LEVEL_NAME
}
